...
namespace strange.extensions.injector.impl
{
    public class CrossContextInjectionBinder : InjectionBinder, ICrossContextInjectionBinder
    {
        ...
        public override IInjectionBinding
            GetBinding<T>(
                object name) //without this override Binder.GetBinding(object,object) gets called instead of CrossContextInjectionBinder.GetBind
        {
            return GetBinding(typeof(T), name);
        }

        public override IInjectionBinding
            GetBinding(object key) //without this override Binder.GetBinding(object,object) gets called instead of CrossContextInjectionBinder.GetBinding(
        {
