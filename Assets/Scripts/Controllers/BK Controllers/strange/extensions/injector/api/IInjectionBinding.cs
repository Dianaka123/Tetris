...
namespace strange.extensions.injector.api
{
    public interface IInjectionBinding : IBinding
    {
        ...
        // Don't add to list of should be destroyed objects that means Dispose and Deconstruct methods should not called after context dispose.
        IInjectionBinding AvoidDestroy();
