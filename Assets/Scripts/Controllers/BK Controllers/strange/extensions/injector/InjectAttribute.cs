...
public class Name : PreserveAttribute
{
...
public class Construct : PreserveAttribute
{
}

//Tag [PostConstruct] to perform post-injection construction actions
[AttributeUsage(AttributeTargets.Method)]
public class PostConstruct : PreserveAttribute
{
}

[AttributeUsage(AttributeTargets.Method)]
public class Deconstruct : PreserveAttribute
{
}