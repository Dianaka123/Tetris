...
namespace strange.extensions.context.impl
{
    public class CrossContext : Context, ICrossContextCapable
    {
        ...
        private IEventDispatcher _crossContextDispatcher;
        ...
        private IBinder crossContextBridge
        {
            get
            {
        ...
        {
            injectionBinder.injector.Deconstruct();
            injectionBinder.injector.Dispose();
            base.Dispose();
        }
    }
}