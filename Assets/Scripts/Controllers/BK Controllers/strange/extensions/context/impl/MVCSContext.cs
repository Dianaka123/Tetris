...
namespace strange.extensions.context.impl
{
    public class MVCSContext : CrossContext
    {
        ...
        public MVCSContext(MonoBehaviour view)
            : base(view)
        {
        }

        public MVCSContext(MonoBehaviour view, ContextStartupFlags flags)
            : base(view, flags)
        {
        }

        public MVCSContext(MonoBehaviour view, bool autoMapping)
        ...
        private void cacheView(MonoBehaviour view)
        {
